...
from cryograph.models.layers import MLPEdgeMessage
from cryograph.models.decoders import Decoder

class GNNEdgeDecoder(Decoder):
    """Decoder passing messages through MLPEdgeMessage layers, with a learned
    attribute per edge.
    """
    def __init__(
        self,
        ...
        for i in range(len(layer_specs)): 
            ...
            self.messpass_list.append(
                MLPEdgeMessage(
                    ...
                    message_channels=spec['message_channels'],
